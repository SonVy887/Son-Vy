...
public class DanhSachNhanSu implements INhanSu {
    ...
    public void timKiem(){// da test
        ...
        for(int i = 0; i < n;i++){
            if(dsns[i].getMaNhanSu().equals(manhansu) && dsns[i] instanceof NhanSuChinhThuc){
                System.out.println("\n=================================================================================================================================================================================");
                System.out.printf("|%-8s|%-9s|%-10s|%-16s|%-15s|%-12s|%-13s|%-11s|%-11s|%-16s|%10s|%22s|%10s|\n",
                "Mã NS","Họ", "Tên",
                "Địa Chỉ", "Số Điện Thoại", "Giới Tính",
                "Ngày Sinh", "Chức Vụ", "Phòng Ban", "Ngày Vào Làm", "Loại NS"," Lương Cơ Bản", "Năm K/N");
                System.out.printf("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
                dsns[i].inThongTin();
                System.out.println("=================================================================================================================================================================================");
                return;
            } else if(dsns[i].getMaNhanSu().equals(manhansu) && dsns[i] instanceof NhanSuThucTap) {
                System.out.println("\n=============================================================================================================================================================================================");
                System.out.printf("|%-8s|%-9s|%-10s|%-16s|%-15s|%-12s|%-13s|%-11s|%-11s|%-16s|%10s|%22s|%14s|%7s|\n",
                "Mã NS","Họ", "Tên",
                "Địa Chỉ", "Số Điện Thoại", "Giới Tính",
                "Ngày Sinh", "Chức Vụ", "Phòng Ban", "Ngày Vào Làm", "Loại NS", "Lương Cơ Bản", "Thời Gian T/T", "GPA");
                System.out.printf("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n");
                dsns[i].inThongTin();
                System.out.println("=============================================================================================================================================================================================");
                return;
    ...
    public void timKiemTheoHo(){
        ...
        boolean found = false;
        for(int i = 0; i < n;i++){
           if(dsns[i].getTenNhanSu().contains(honhansu) && dsns[i] instanceof NhanSuChinhThuc){
                System.out.println("\n=================================================================================================================================================================================");
                System.out.printf("|%-8s|%-9s|%-10s|%-16s|%-15s|%-12s|%-13s|%-11s|%-11s|%-16s|%10s|%22s|%10s|\n",
                "Mã NS","Họ", "Tên",
                "Địa Chỉ", "Số Điện Thoại", "Giới Tính",
                ...
                System.out.println("=================================================================================================================================================================================");
                found = true;
            } else if(dsns[i].getTenNhanSu().contains(honhansu) && dsns[i] instanceof NhanSuThucTap) {
                System.out.println("\n=============================================================================================================================================================================================");
                System.out.printf("|%-8s|%-9s|%-10s|%-16s|%-15s|%-12s|%-13s|%-11s|%-11s|%-16s|%10s|%22s|%14s|%7s|\n",
                "Mã NS","Họ", "Tên",
                "Địa Chỉ", "Số Điện Thoại", "Giới Tính",
    ...
    public void timKiemTheoTen(){
        System.out.print("Nhập tên nhân sự cần tìm kiếm: ");
        String tennhansu = sc.nextLine();

        boolean found = false;
        for(int i = 0; i < n; i++){
            if(dsns[i].getTenNhanSu().contains(tennhansu) && dsns[i] instanceof NhanSuChinhThuc){
                System.out.println("\n=================================================================================================================================================================================");
                System.out.printf("|%-8s|%-9s|%-10s|%-16s|%-15s|%-12s|%-13s|%-11s|%-11s|%-16s|%10s|%22s|%10s|\n",
                "Mã NS","Họ", "Tên",
                "Địa Chỉ", "Số Điện Thoại", "Giới Tính",
                ...
                System.out.println("=================================================================================================================================================================================");
                found = true;
            } else if(dsns[i].getTenNhanSu().contains(tennhansu) && dsns[i] instanceof NhanSuThucTap) {
                System.out.println("\n=============================================================================================================================================================================================");
                System.out.printf("|%-8s|%-9s|%-10s|%-16s|%-15s|%-12s|%-13s|%-11s|%-11s|%-16s|%10s|%22s|%14s|%7s|\n",
                "Mã NS","Họ", "Tên",
                "Địa Chỉ", "Số Điện Thoại", "Giới Tính",
